...
and a model based of microbenchmarks. We evaluate the models on
multiple matrix and number of MPI processes. Our evaluation show
thatwhile the SVR model may provide better accuracy of the prediction,
...
microbenchmark based model is not does not perform as well, ranging
