...
We also generated three larger matrices using the R-MAT model~\cite{chakrabarti2004r}. We
generated the R-MAT matrices using parameter $a=0.33$, $b=0.33$ and
$c=0.33$. In the name of the matrix the first numerical value in the
name represent the total number of edges and the second value
...
\begin{table*}
\caption{All SpMV prediction model performance. \todo{columns should be ordered like in the previous tables. Any chance we will get the models for linear and benchmark based?}}
