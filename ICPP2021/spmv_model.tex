...
\begin{figure}[hbt!]
\centering
\subfigure[Nonzero per row vs run time for different matrices.]{\includegraphics[width=0.48\linewidth]{figures/model_nonzero_perRow_for_particular_row_process_100.pdf}\label{fig:npr}}
...
\end{eqnarray*}
\begin{table}[htb]
\caption{Benchmark SpMV Model on Random CSR 2D Partitioning(on Skylake).}
\label{tab:overall-spmv-csr-2d-single}
\let\center\empty
\let\endcenter\relax
\centering
\resizebox{.8\width}{!}{\input{table/bench_model_csr_2d_info.tex}}

\end{table}

\begin{table}[htb]
\caption{Benchmark SpMV Model on Random COO 2D Partitioning(on Skylake).}
\label{tab:overall-spmv-coo-2d-single}
\let\center\empty
\let\endcenter\relax
\centering
\resizebox{.8\width}{!}{\input{table/bench_model_coo_2d_info.tex}}
\end{table}
...
\begin{table}[htb]
\caption{Benchmark SpMV Model on Local CSR 1D-Row Partitioning(on Skylake).}
\label{tab:overall-spmv-csr-lk-single}
\let\center\empty
\let\endcenter\relax
\centering
\resizebox{.8\width}{!}{\input{table/bench_model_local_csr_1d_info.tex}}
\end{table}

\begin{table}[htb]
\caption{Benchmark SpMV Model on Local COO 1D-Row Partitioning(on Skylake).}
...
\begin{table}[htb]
\caption{Benchmark SpMV Model on Global CSR 1D-Row Partitioning(on Skylake).}
\label{tab:overall-spmv-csr-gk-single}
\let\center\empty
\let\endcenter\relax
\centering
\resizebox{.8\width}{!}{\input{table/bench_model_global_csr_1d_info.tex}}
\end{table}

\begin{table}[htb]
\caption{Benchmark SpMV Model on Global COO 1D-Row Partitioning(on Skylake).}
\label{tab:overall-spmv-coo-gk-single}
\let\center\empty
\let\endcenter\relax
\centering
\resizebox{.8\width}{!}{\input{table/bench_model_global_coo_1d_info.tex}}
\end{table}
...
\let\endcenter\relax
\centering
\resizebox{.8\width}{!}{\input{table/linear_csr_2d_info.tex}}
\end{table}
...
\let\endcenter\relax
\centering
\resizebox{.8\width}{!}{\input{table/linear_coo_2d_info.tex}}
\end{table}
...
\let\endcenter\relax
\centering
\resizebox{.99\width}{!}{\input{table/overall_svr_model_info.tex}}
\end{table*}
...
\begin{table*}
\caption{Actual Run Time of All SpMV model  on Skylake.}
...
\begin{table*}
\caption{Overall All SpMV model performance  on Skylake.}
\label{tab:performance_table}
\let\center\empty
\let\endcenter\relax
\centering
