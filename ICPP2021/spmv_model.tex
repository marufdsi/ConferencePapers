...
represent the zeros in matrices and only represent the non-zer values
in the matrix.

\subsubsection{Compressed Storage by Row (CSR)}

The Compressed Storage by Row format represents a matrix with three
arrays: \texttt{rowA}, \texttt{colA}, and \texttt{valA}. 

\begin{figure}
  \begin{subfigure}[b]{4em}
    $\begin{pmatrix}
      1 & 2 & 3 & 0 & 0 \\
      0 & 0 & 4 & 5 & 6 \\
      0 & 2 & 0 & 0 & 0 \\
...
\begin{figure}[hbt!]
  ...
  \begin{subfigure}[b]{.5\textwidth}
    \includegraphics[width=0.48\linewidth]{figures/model_nonzero_perRow_for_particular_row_process_100.pdf}
    \label{fig:npr}
    \caption{Nonzero per row vs run time for different matrices.}
  \end{subfigure}
  \begin{subfigure}[b]{.5\textwidth}
    \includegraphics[width=0.48\linewidth]{figures/prediction_equation.pdf}
...
\begin{figure}[hbt!]
  \centering
  \begin{subfigure}[b]{.5\textwidth}
    \includegraphics[width=0.48\linewidth]{figures/fma/skylake_mpi_fma_roofline_model_for_vec_4.pdf}
    \label{fig:mpi-skl-vec-4}
    \caption{Vector Width: 4}
  \end{subfigure}

  \begin{subfigure}[b]{.5\textwidth}
    \includegraphics[width=0.48\linewidth]{figures/fma/skylake_mpi_fma_roofline_model_for_vec_8.pdf}
...
\begin{figure}[hbt!]
  \centering
  \begin{subfigure}[b]{.5\textwidth}
    \includegraphics[width=0.48\linewidth]{figures/stream/skylake_mpi_copy_single_precision.pdf}
    \label{fig:stream-single-copy}
    \caption{Single Precision.}
  \end{subfigure}

  \begin{subfigure}[b]{.5\textwidth}
    \includegraphics[width=0.48\linewidth]{figures/stream/skylake_mpi_copy_double_precision.pdf}
