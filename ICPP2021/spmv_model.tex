...
\begin{table}[htb]
\caption{Properties of the test matrices.\todo{can you add average degree?}}
...
\begin{table*}
\caption{All SpMV prediction model performance. \todo{can we have harmonic mean of error at the bottom for each model?}}
